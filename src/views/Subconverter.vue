...
export default {
  ...
  methods: {
    ...
    makeUrl() {
      ...
      // 薯条屏蔽
      if (sourceSub.indexOf("losadhwse") !== -1 && (backend.indexOf("py6.pw") !== -1 || backend.indexOf("subconverter-web.now.sh") !== -1 || backend.indexOf("subconverter.herokuapp.com") !== -1 || backend.indexOf("api.wcc.best") !== -1 || backend.indexOf("sub.con8.tk") !== -1 || backend.indexOf("subcon.dlj.tf") !== -1 || backend.indexOf("sub.con8.tk") !== -1 || backend.indexOf("api.dler.io") !== -1)) {
